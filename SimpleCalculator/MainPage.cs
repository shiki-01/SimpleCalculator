...
public sealed partial class MainPage : Page
{
    public MainPage()
    {
        this
            ...
            .DataContext(new BindableMainModel(this.GetThemeService()), (page, vm) => page
                .Content
                (
                    new Border()
    ...
    private static UIElement Header(BindableMainModel vm) =>
        new ToggleButton()
            .Grid(row: 0)
            .Margin(8, 24, 8, 0)
            .CornerRadius(20)
            ...
            .IsChecked(b => b.Binding(() => vm.IsDark).TwoWay())
            .Content
            (
                new PathIcon()
                    .Data(AppIcons.Light)
    ...
    private static UIElement Output(BindableMainModel vm) =>
        new StackPanel()
            .Grid(row: 2)
            .Spacing(16)
            .Padding(16, 8)
    ...
    private static UIElement Keypad(BindableMainModel vm) =>
        new Grid()
            .Grid(row: 3)
            .RowSpacing(16)
            .ColumnSpacing(16)
